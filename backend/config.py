...
PRE_FIRE_MODELS_DIR = BACKEND_ROOT / "prefire" / "models"
POST_FIRE_MODELS_DIR = BACKEND_ROOT / "postfire" / "models"
SPREAD_MODELS_DIR = BACKEND_ROOT / "postfire" / "models"
...
ENSEMBLE_MODELS = {
    ...
    'xgboost': PRE_FIRE_MODELS_DIR / "xgboost_enhanced_model.pkl"
}
